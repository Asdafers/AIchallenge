...
1. **End-to-end ADK agent pipeline** — SequentialAgent + LoopAgent graph with 7 LlmAgents and 4 custom BaseAgent steps, running on Cloud Run with live Gemini 2.5 Pro.
